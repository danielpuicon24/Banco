...
public class AgenciaMapaActivity extends AppCompatActivity  implements OnMapReadyCallback, GoogleMap.OnMarkerDragListener, GoogleMap.OnMapClickListener, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agencia_mapa);
        ...
        int codigo_agencia = parametros.getInt("p_cod_agencia");

        if (codigo_agencia == 0){ //Es para cuando estamos agregando
